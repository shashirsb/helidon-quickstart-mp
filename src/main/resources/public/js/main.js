...
(function ($) {
	...
	console.log("at login"+combined);
		var request;
		request = $.ajax({
			url: 'http://141.148.56.156:8080/user/login' + combined,
			type: 'GET',
			dataType: 'json',
			async: false,
			...
			error: function(data) {
				...
				window.location.href = "http://141.148.56.156:8080/login.html";
			}
		...
		request.done(function(jqXHR, textStatus, response) {
			...
			setTimeout(function() {
				...
				window.location.href = "http://141.148.56.156:8080/success.html";
			}, delayInMilliseconds);
			} else {
